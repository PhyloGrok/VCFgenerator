...
for infile in ${BASE_DATA_DIR}/VCF.projects/$txid/data/untrimmed_fastq/*_1.fastq
	do
		...
		${BASE_DATA_DIR}/VCF.projects/$txid/data/trimmed_fastq/${base}_2.trim.fastq ${BASE_DATA_DIR}/VCF.projects/$txid/data/trimmed_fastq/${base}_2.untrim.fastq SLIDINGWINDOW:4:20 MINLEN:25 ILLUMINACLIP:NexteraPE-PE.fa:2:40:15
	done
