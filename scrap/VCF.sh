...
for infile in ~/VCF.projects/$txid/data/trimmed_fastq/*_1.trim.fastq
	...
	bwa mem ~/VCF.projects/$txid/data/ref_genome/ncbi_dataset/data/GC*/GC*.fna ~/VCF.projects/$txid//data/trimmed_fastq/${base}_1.trim.fastq \
	...
	vcfutils.pl varFilter ~/VCF.projects/$txid/results/vcf/${base}_variants.vcf  > ~/VCF.projects/$txid/results/${base}_final_variants.vcf
	done
