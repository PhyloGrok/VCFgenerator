...
mkdir -m777 /media/volume/sdb/$1/fastq
mkdir -m777 /media/volume/sdb/$1/fastq/untrimmed
mkdir -m777 /media/volume/sdb/$1/fastq/trimmed
mkdir -m777 /media/volume/sdb/$1/assembly
mkdir -m777 /media/volume/sdb/$1/assembly/reference
mkdir -m777 /media/volume/sdb/$1/assembly/results
mkdir -m777 /media/volume/sdb/$1/assembly/results/sam
mkdir -m777 /media/volume/sdb/$1/assembly/results/bam
mkdir -m777 /media/volume/sdb/$1/assembly/results/bcf
mkdir -m777 /media/volume/sdb/$1/assembly/results/vcf
mkdir -m777 /media/volume/sdb/$1/assembly/results/final_vcf
mkdir -m777 /media/volume/sdb/$1/assembly/results/annotation
## Web-search
