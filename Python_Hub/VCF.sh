...
bwa mem -t 4 $2/$1/assembly/reference/ref_genome.fasta $2/$1/fastq/trimmed/${name}_1.trim.fastq.gz $2/$1/fastq/trimmed/${name}_2.trim.fastq.gz > $2/$1/assembly/results/sam/${name}.aligned.sam
done
...
do
name=$(basename ${x} _1.fastq.gz)
vcfutils.pl varFilter $2/$1/assembly/results/vcf/${name}.vcf > $2/$1/assembly/results/final_vcf/${name}_final_variants.vcf
done
