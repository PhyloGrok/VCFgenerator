...
trimmomatic PE ../../media/volume/sdb/$pname/fastq/${infile} ../../media/volume/sdb/$pname/fastq/${base}_2.fastq.gz ../../media/volume/sdb/$pname/fastq/trimmed/${base}_1.trim.fastq.gz ../../media/volume/sdb/$pname/fastq/untrimmed/${base}_1.untrim.fastq.gz ../../media/volume/sdb/$pname/fastq/trimmed/${base}_2.trim.fastq.gz ../../media/volume/sdb/$pname/fastq/untrimmed/${base}_2.untrim.fastq.gz;
