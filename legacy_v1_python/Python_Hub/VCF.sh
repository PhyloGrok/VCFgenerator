...
bwa mem -t 8 $4/$1/assembly/reference/ref_genome.fasta $4/$1/fastq/trimmed/${name}_1.trim.fastq.gz $4/$1/fastq/trimmed/${name}_2.trim.fastq.gz > $4/$1/assembly/results/sam/${name}.aligned.sam
done
